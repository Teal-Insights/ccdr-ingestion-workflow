...
from utils.opencode_client import OpenCodeClient, FileInput
...
{", ".join(ALLOWED_TAGS)}"""
        ...
        with OpenCodeClient() as fixup_client:
...
if __name__ == "__main__":
    ...
    try:
        structured_nodes = restructure_with_opencode(
            ...
            timeout_seconds=3600  # 30 minutes for complex document restructuring
        )
        end_time = time.time()
