...
def create_text_block_html(block: TextBlock, rich_text: bool, bboxes: bool, block_id: int | None = None) -> str:
...
def create_image_block_html(block: ImageBlock, bboxes: bool, block_id: int | None = None) -> str:
...
def create_svg_block_html(block: SvgBlock, bboxes: bool, block_id: int | None = None) -> str:
...
def create_block_html(block: Block, rich_text: bool, bboxes: bool, block_id: int | None = None) -> str:
...
def convert_blocks_to_html(input_path: str, output_path: str, rich_text: bool = False, bboxes: bool = False, include_ids: bool = False) -> str:
    """
